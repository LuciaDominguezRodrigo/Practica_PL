...
Sustituye Translator por el nombre del fichero que contiene la especificación de la gramática ANTLR (extensión .g4)
*/
...
TranslatorParser anasint = new TranslatorParser(tokens, new sintesis());
*/
/*
